...
! function($) {'use strict';
    ...
    BFHCurrencies.prototype = {
        ...
        addBootstrapCurrencies : function() {
            var $input, $toggle, $options, value, currency;
...
! function($) {'use strict';
    ...
    var toggle = '[data-toggle=bfh-datepicker]', BFHDatePicker = function(element, options) {
    ...
    BFHDatePicker.prototype = {
        ...
        parse : function(element, date) {
            var format, monthPos, yearPos, dayPos, indexes, parts, i;
        ...
        updateCalendar : function() {
            var $calendar, $daysHeader, $days, today, month, year, lowerlimit, lowerday, lowermonth, loweryear, higherlimit, higherday, highermonth, higheryear, numDaysPrevious, numDays, firstDay, lastDay, row, previousDay, day, i, j;
    ...
    $(function() {
        $('html').on('click.bfhdatepicker.data-api', clearMenus);
...
! function($) {'use strict';
    ...
    BFHFonts.prototype = {
        ...
        addBootstrapFonts : function() {
            var $input, $toggle, $options, value, f;
...
! function($) {'use strict';
    ...
    BFHFontSizes.prototype = {
        ...
        addBootstrapFontSizes : function() {
            var $input, $toggle, $options, value, s;
...
! function($) {'use strict';
    ...
    BFHGoogleFonts.prototype = {
        ...
        addBootstrapFonts : function() {
            var $input, $toggle, $options, value, f, entry;
...
! function($) {'use strict';
    ...
    BFHLanguages.prototype = {
        ...
        addLanguages : function() {
            var value, available, languages, language, languageArr, i;
        ...
        addBootstrapLanguages : function() {
            var $input, $toggle, $options, value, available, languages, language, languageArr, i;
...
! function($) {'use strict';
    ...
    var BFHPhone = function(element, options) {
        var country, formObject, countryObject;
    ...
    BFHPhone.prototype = {
        ...
        getFormattedNumber : function() {
            var format, phoneNumber, formattedNumber, newNumber, j, i;
        ...
        change : function() {
            var $this, start, end, replaceAtEnd, number, newNumber, i;
    ...
    $(function() {
        $('body').on('propertychange.bfhphone.data-api change.bfhphone.data-api input.bfhphone.data-api keyup.bfhphone.data-api', '.bfh-phone', BFHPhone.prototype.change).on('change.bfhphone.data-api', '.bfh-country', BFHPhone.prototype.changeCountry);
    });
...
+ function($) {'use strict';
    ...
    var backdrop = '.bfh-selectbox-backdrop', toggle = '[data-toggle=bfh-selectbox]', BFHSelectBox = function(element) {
    ...
    BFHSelectBox.prototype = {
        ...
        toggle : function(e) {
            ...
            if (!isActive) {
                ...
                $parent.toggleClass('open').trigger('shown.bfhselectbox').find('[role=option] > li > [data-option="' + $this.find('.bfh-selectbox-option').data('option') + '"]').focus();
            }
    ...
    $(document).on('click.bfhselectbox.data-api', clearMenus).on('click.bfhselectbox.data-api focus.bfhselectbox.data-api touchstart.bfhselectbox.data-api', toggle, BFHSelectBox.prototype.toggle).on('keydown.bfhselectbox.data-api', toggle + ', [role=option]', BFHSelectBox.prototype.keydown).on('mouseenter.bfhselectbox.data-api', '[role=option] > li > a', BFHSelectBox.prototype.mouseenter).on('click.bfhselectbox.data-api', '[role=option] > li > a', BFHSelectBox.prototype.select).on('click.bfhselectbox.data-api', '.bfh-selectbox-filter', function() {
        return false;
        ...
        addBootstrapStates : function() {
            ...
            if (country !== '') {
                ...
                if ($country.length !== 0) {
                    ...
                    $country.on('change.bfhselectbox', {
                        state : this
...
! function($) {'use strict';
    ...
    var toggle = '[data-toggle=bfh-timepicker]', BFHTimePicker = function(element, options) {
    ...
    $(function() {
        $('html').on('click.bfhtimepicker.data-api', clearMenus);
        $('body').on('click.bfhtimepicker.data-api focus.bfhtimepicker.data-api touchstart.bfhtimepicker.data-api', toggle, BFHTimePicker.prototype.toggle).on('click.bfhtimepicker.data-api touchstart.bfhtimepicker.data-api', '.bfh-timepicker-popover > table .hour > .previous', BFHTimePicker.prototype.previousHour).on('click.bfhtimepicker.data-api touchstart.bfhtimepicker.data-api', '.bfh-timepicker-popover > table .hour > .next', BFHTimePicker.prototype.nextHour).on('click.bfhtimepicker.data-api touchstart.bfhtimepicker.data-api', '.bfh-timepicker-popover > table .minute > .previous', BFHTimePicker.prototype.previousMinute).on('click.bfhtimepicker.data-api touchstart.bfhtimepicker.data-api', '.bfh-timepicker-popover > table .minute > .next', BFHTimePicker.prototype.nextMinute).on('click.bfhtimepicker.data-api touchstart.bfhtimepicker.data-api', '.bfh-timepicker-popover > table', function() {
            return false;
        });
    });
...
! function($) {'use strict';
    ...
    BFHTimezones.prototype = {
        ...
        addTimezones : function() {
            ...
            if (country !== '') {
                ...
                if (countryObject.length !== 0) {
                    ...
                    countryObject.on('change.bfhcountries.data-api', {
                        timezoneObject : this
                    }, this.changeCountry);
                }
            }
        ...
        changeCountry : function(e) {
            var $this, timezoneObject, country;
        ...
        addBootstrapTimezones : function() {
            ...
            if (country !== '') {
                ...
                if (countryObject.length !== 0) {
                    ...
                    countryObject.find('input[type="hidden"]').on('change.bfhcountries.data-api', {
                        timezoneObject : this
                    }, this.changeBootstrapCountry);
                }
            }
