...
(function( $ )
{
	...
	function test( $i, o )
	{
		...
		return $i.outerHeight() > o.maxHeight;
	}
	...
	{
		//Donna - Check visibility first and don't return text of hidden node.
		if (!$(e).is(":visible")) {
			return "";
		}
		//Donna - Element has child nodes.
		else if ($(e).children().length > 0) {
			return getTextContent($(e).children().get(0));
		}
		else if ( e.innerText )
		{
			return e.innerText;
