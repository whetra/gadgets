...
var ContentFlowGlobal = {
    ...
    initPath: function () {
        ...
        if (!this.scriptElement) {
            this.scriptName = 'ContentFlow.js';
            this.scriptElement = this.getScriptElement(this.scriptName);
        }
        ...
        if (!this.CSSBaseDir) {
            ...
            this.CSSBaseDir = "https://s3.amazonaws.com/Common-Production/ContentFlow/css/"; //Donna            
        }
    },
...
*/
     ...
     */
    _addItemCue: [],
    _addItemCueProcess: function (deleteFirst) {    //Called for first and last item.
        ...
        if (c.length > 0 && ! c[0].p) {
            ...
            window.setTimeout(function () {
                self._addItem(c[0].el, c[0].i, c[0].onItemAdded)
            }, t);  //Donna - added callback.
        }
    },
