...
//Issue 916 Start - Add event handlers back after card is closed.
...
function webGLStart() {
    if (!glCanvas) {
        ...
        //Issue 916 - Need to add a bit of a delay before the event is fired.
        //Otherwise the event handlers will be added back too soon and will execute.
        //Not ideal, but it works.
        glCanvas.addEventListener('onCardClosed', function() {
            setTimeout(onCardClosed, 500);
        });
    }
}
...
function handleClick() {
    ...
    while (i--) {
        ...
        var ch = 0.66; //card height is .066 (from 0.34 to 1.0)
        var cLeft = c.x - cw / 2;
        var cTop = c.y + ch / 2;
