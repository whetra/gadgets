...
rd.ip.floatingProfileCard.renderTexture = function(profile, texture) {
    ...
    this.context.drawImage(rd.ip.core.floatingProfileBgImg, 0, 0, w, h);

    var imageHeight = h - 20;
    var imageWidth = imageHeight * 4 / 5;
    ...
    this.context.fillText(profile.firstName + " " + profile.lastName, textCenterPos, 80, textCenterPos * 2 - 20);
    ...
    this.context.fillText(profile.level, textCenterPos, 110, textCenterPos * 2 - 20);
    ...
    if (profileImage) {
        this.context.drawImage(profileImage, w - imageWidth - 10, 10, imageWidth, imageHeight);
    }
